...
type Repo interface {
	...
	GetAll(ctx context.Context, q string, offset, limit int) ([]Project, error)
}

type Service interface {
	ResetRepo(ctx context.Context) error
	GetAll(ctx context.Context, qp models.SearchQP) ([]Project, error)
	Get(ctx context.Context, id int) (Project, error)
}
...
func (p *projects) GetAll(ctx context.Context, qp models.SearchQP) ([]Project, error) {
